 ...
 */
function tainacan_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	$saturation         = absint( apply_filters( 'tainacan_custom_colors_saturation', 50 ) );
	 ...
	 */
	return apply_filters( 'tainacan_custom_colors_css', $css, $hue, $saturation );
}

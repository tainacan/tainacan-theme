	...
	<div class="container-fluid px-0 t-bg-collection" style="<!-- z-index: 0; -->">
		<div class="collection-header position-relative max-large" style="">
			...
			<?php if ( has_post_thumbnail( tainacan_get_collection_id() ) ) : 
				...
				<img src="<?php echo esc_url( get_the_post_thumbnail_url( tainacan_get_collection_id() ) ); ?>" class="t-collection--info-img rounded-circle img-fluid border border-white position-absolute text-left" alt="<?php echo esc_attr($alt); ?>">
			<?php else : ?>

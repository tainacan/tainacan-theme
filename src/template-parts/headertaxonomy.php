...
/* echo '<pre>'; var_dump($term); die;
$thumb = wp_get_attachment_image_src($term->get_header_image_id()); */
?>
...
<div class="page-header-taxonomy max-large">
	...
	<div class="container-fluid m-0 p-0 d-flex flex-wrap">
		...
		<div class="col-12 col-sm-4 p-0 page-header-image" style="background-image: url('<?php echo get_template_directory_uri() ?>/assets/images/capa.png');"></div>
